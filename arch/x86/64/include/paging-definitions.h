...
static_assert(sizeof(PageMapLevel4Entry) == 8,
              "PageMapLevel4Entry is not 64 bit");
...
static_assert(sizeof(PageDirPointerTablePageDirEntry) == 8,
              "PageDirPointerTablePageDirEntry is not 64 bit");
...
static_assert(sizeof(PageDirPointerTablePageEntry) == 8,
              "PageDirPointerTablePageEntry is not 64 bit");
...
static_assert(sizeof(PageDirPageTableEntry) == 8,
              "PageDirPageTableEntry is not 64 bit");
