...
#define PRINT(X) do { if (A_BOOT & OUTPUT_ENABLED) { writeLineDebug(VIRTUAL_TO_PHYSICAL_BOOT(X)); } } while (0)
...
extern "C" void entry()
{
  ...
  PRINT("AOS bootstrap starting...\n");

  PRINT("Wiping framebuffer...\n");
  memset((void*)(ArchCommon::getFBPtr(0)), 0, 80 * 25 * 2);

  PRINT("Zeroing BSS section...\n");
