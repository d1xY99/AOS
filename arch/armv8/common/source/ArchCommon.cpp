...
{
  extern unsigned char aosdbg_start_address_nr;
  extern unsigned char aosdbg_end_address_nr;

  kernel_debug_info = new AOSDebugInfo((const char *)&aosdbg_start_address_nr, (const char*)&aosdbg_end_address_nr);
}
