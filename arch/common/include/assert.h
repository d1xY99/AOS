...
#define assert(cond) do { (cond) ? (void)0 : aos_assert( #cond ,__LINE__,__FILE__); } while (0)
 ...
 */
__attribute__((noreturn)) void aos_assert(const char *condition, uint32 line, const char* file);
