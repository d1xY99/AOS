...
public:
  ...
  static const Elf32_Word PT_TLS = 7;
  static const Elf32_Word PT_HIPROC = 8;
  static const Elf32_Word PT_GNU_STACK = 9;

  // Program header flags
  static const Elf32_Word PF_X = 0x1;
  static const Elf32_Word PF_W = 0x2;
  static const Elf32_Word PF_R = 0x4;
...
#define foobar(x) kprintfd("hdr " #x ": %x\n", hdr.x)
  ...
  static bool headerCorrect(Ehdr *hdr) {
    if (hdr->e_ident[Elf::EI_MAG0] == 0x7f &&
        ...
        (hdr->e_machine == Elf::EM_386 || hdr->e_machine == Elf::EM_ARM) &&
