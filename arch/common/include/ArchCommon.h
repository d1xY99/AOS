...
public:
  ...
  /**
   * @param is_paging_set_up inform function that paging is not yet up (=false)
   * and that it should behave accordingly
   */
   ...
   */
  static size_t getUsableMemoryRegion(size_t region, pointer &start_address,
  ...
  static void drawAdditionalStat();
};
