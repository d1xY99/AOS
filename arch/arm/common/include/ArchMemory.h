 ...
 * Privilege Mechanism
 */
  __attribute__((warn_unused_result)) bool mapPage(uint32 virtual_page, uint32 physical_page,
                                                  uint32 user_access, uint32 writeable = 1, bool executable = true);
