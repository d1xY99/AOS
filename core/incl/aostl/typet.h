...
struct SuperSubclass {
    enum { value = (::aostl::tm::Conversion<const volatile U*, const volatile T*>::exists &&
		    !::aostl::tm::Conversion<const volatile T*, const volatile void*>::sameType) };
...
struct SuperSubclassStrict {
    enum { value = SuperSubclass<T,U>::value &&
		    !::aostl::tm::Conversion<const volatile T*, const volatile U*>::sameType };
};
...
#define static_assert(cond,msg)	{ ::aostl::tm::CompileTimeError<!!(cond)> ERROR_##msg; (void) ERROR_##msg; }
#endif
