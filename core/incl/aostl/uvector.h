...
/// \class vector uvector.h aostl.h
/// \ingroup Sequences
///
...
public:
    ...
    typedef ::aostl::reverse_iterator<iterator>	reverse_iterator;
    typedef ::aostl::reverse_iterator<const_iterator>	const_reverse_iterator;
public:
    inline			vector (void);
