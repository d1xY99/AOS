...
public:
    ...
    inline void			remove (const T& v)		{ ::aostl::remove (*this, v); }
    template <typename Predicate>
    inline void			remove_if (Predicate p)		{ ::aostl::remove_if (*this, p); }
    inline void			reverse (void)			{ ::aostl::reverse (*this); }
    inline void			unique (void)			{ ::aostl::unique (*this); }
    inline void			sort (void)			{ ::aostl::sort (*this); }
    void			merge (list<T>& l);
...
void list<T>::merge (list& l)
{
    ...
    ::aostl::merge (this->iat(l.size()), end(), l.begin(), l.end(), begin());
}
