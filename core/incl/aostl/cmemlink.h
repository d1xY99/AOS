...
/// The aostl namespace contains all aostl classes and algorithms.
namespace aostl {
...
/// \class cmemlink cmemlink.h aostl.h
...
public:
    ...
    inline void		swap (cmemlink& l)		{ ::aostl::swap (_data, l._data); ::aostl::swap (_size, l._size); }
   ...
   inline const_pointer	cdata (void) const		{ return _data; }
    ...
    inline void		read (istream&)			{ assert (!"aostl::cmemlink is a read-only object."); }
