...
public:
  ...
  KernelDebugInfo(char const *stab_begin, char const *stab_end, char const *stab_str);
  virtual ~KernelDebugInfo();
...
protected:
  ...
  aostl::map<size_t, StabEntry const*> function_symbols_;
