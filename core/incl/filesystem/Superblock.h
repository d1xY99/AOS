...
class Superblock
{
  ...
  protected:
     ...
     */
    aostl::list<Inode*> dirty_inodes_;

    /**
     * A list of used inodes. It is only used to open-file.
     */
    aostl::list<Inode*> used_inodes_;

    /**
     * inodes of the superblock.
     */
    aostl::list<Inode*> all_inodes_;
  ...
  public:
     ...
     */
    Superblock(FsTypeReg* fs_type, size_t s_dev);
