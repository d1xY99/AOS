...
public:
  ...
  /**
   * Writes Data starting at the offset from the buffer with the given length to
   * the terminal.
  ...
  /**
   * Reads the given number of characters from the input or until the end of
   * line.
  ...
  /**
   * Reads the given number of characters from the input or until the end of
   * line. and don't remove control characters from the string
   * @param line the buffer to write
   * @param size the number of characters to read
   * @return the number of chracters read
   */
  ...
  /**
   * Reads the given number of characters from the input or until the end of
   * line or until there is no more input
   * @param line the buffer to write
   * @param size the number of characters to read
   * @return the number of chracters read
   */
  ...
  bool isLockFree() { return mutex_.isFree(); }

  void print404(const char* error_message = "");
