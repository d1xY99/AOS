...
#define OUTPUT_ADVANCED 0x80000000
#define OUTPUT_FLAGS (OUTPUT_ENABLED | OUTPUT_ADVANCED)

#ifndef NOCOLOR
#define DEBUG_FORMAT_STRING "\033[1;%zum%s:\033[0;39m "
...
#define debug(flag, ...)                                                       \
  do {                                                                         \
    if (flag & OUTPUT_ENABLED) {                                               \
      kprintfd(DEBUG_FORMAT_STRING, COLOR_PARAM(flag));                        \
      kprintfd(__VA_ARGS__);                                                   \
    }                                                                          \
  } while (0)
#endif
...
const size_t PIPE = Ansi_Red | OUTPUT_ENABLED;
const size_t THREADS_STACK_MANAGER = Ansi_Yellow | OUTPUT_ENABLED;
const size_t SWAP = Ansi_Red | OUTPUT_ENABLED;
const size_t DUP = Ansi_Yellow | OUTPUT_ENABLED;
const size_t HEAP_MANAGER = Ansi_Magenta | OUTPUT_ENABLED;
const size_t IPT_MANAGER = Ansi_Cyan | OUTPUT_ENABLED;
...
const size_t RENAME = Ansi_Red | OUTPUT_ENABLED;
const size_t TRUNCATE = Ansi_Red | OUTPUT_ENABLED;
const size_t ACCESS = Ansi_Red | OUTPUT_ENABLED;
