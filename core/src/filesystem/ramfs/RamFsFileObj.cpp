...
RamFsFileObj::RamFsFileObj(Inode* inode, Dentry* dentry, uint32 flag) :
...
RamFsFileObj::~RamFsFileObj()
{
}

int32 RamFsFileObj::read(char *buffer, size_t count, l_off_t offset)
{
...
int32 RamFsFileObj::write(const char *buffer, size_t count, l_off_t offset)
{
...
int32 RamFsFileObj::open(uint32 __attribute__((unused)) flag)
{
  return 0;
}

int32 RamFsFileObj::close()
{
  return 0;
}

int32 RamFsFileObj::flush()
{
  return 0;
}
